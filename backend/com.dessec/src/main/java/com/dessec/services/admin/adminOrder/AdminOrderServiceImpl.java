...
import com.dessec.entity.Order;
...
public class AdminOrderServiceImpl implements AdminOrderService{
    ...
    public AnalyticsResponse calculateAnalytics(){
        ...
        Long currentMonthOrders = getTotalOrdersForMonth(currentDate.getMonthValue(),
                currentDate.getYear());
        Long previousMonthOrders = getTotalOrdersForMonth(previousMonthDate.getMonthValue(),
                previousMonthDate.getYear());

        Long currentMonthEarnings = getTotalEarningsForMonth(currentDate.getMonthValue(),
                currentDate.getYear());
