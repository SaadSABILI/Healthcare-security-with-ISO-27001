package com.dessec.controller.customer;

import com.dessec.dto.OrderedProductsResponseDto;
import com.dessec.dto.ReviewDto;
import com.dessec.services.customer.review.ReviewService;
...
public class ReviewController {
    ...
    @PostMapping("/review")
    public ResponseEntity<?> giverReview(@ModelAttribute ReviewDto reviewDto) throws IOException {
